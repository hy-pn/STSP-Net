...
class SSCDl(nn.Module):
    def __init__(self, in_channels=3, num_classes=7):
        ...
        self.FCN = FCN(in_channels, pretrained=False)
        self.classifier1 = nn.Conv2d(128, 7, kernel_size=1)
        self.classifier2 = nn.Conv2d(128, 7, kernel_size=1)
        # self.classifier1 = nn.Sequential(nn.Conv2d(128, 128, kernel_size=1), nn.BatchNorm2d(128), nn.ReLU(), nn.Conv2d(128, 2, kernel_size=1))
        # self.classifier2 = nn.Sequential(nn.Conv2d(128, 128, kernel_size=1), nn.BatchNorm2d(128), nn.ReLU(), nn.Conv2d(128, 8, kernel_size=1))
        ...
        initialize_weights(self.FCN,self.classifier1, self.classifier2, self.resCD, self.classifierCD)
