...
def main():
    ...
    Score, IoU_mean, IoU_fg, Sek, Fscd, Fscd1, changepre, recall,kappa= SCDD_eval_all_test(preds_all, tests_all, RS.num_classes)
    print('Score: %.2f mIoU: %.2f IoU: %.2f Sek: %.2f Fscd: %.2f  F1: %.2f  changepre: %.2f  recall: %.2f  kappa: %.2f'\
    %(Score*100, IoU_mean*100, IoU_fg*100, Sek*100 , Fscd*100, Fscd1*100, changepre*100, recall*100,kappa*100))
